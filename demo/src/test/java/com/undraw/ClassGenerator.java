...
public class ClassGenerator {
    ...
    private String url = "jdbc:mysql://localhost:3306/report?serverTimezone=GMT%2B8";
    ...
    public void codeGenerator(String tableName){
        ...
        for (Map<String, Object> column : columns) {
            ...
            String annotation = StrUtils.isNull(String.valueOf(column.get("COLUMN_COMMENT")), property);//注解
            sb.append(String.format("\t@Schema(title = \"%s\")\n", annotation));
