...
public class RestTemplateUtil {
    ...
    public <T> Result<T> getResult(String url, Map<String, ?> param, Class<T> type) {
        return ConvertUtils.toObject(get(url, param), new TypeReference<Result<T>>() {});
    }

    public <T> Result<T> getResult(String url, Class<T> type) {
        return ConvertUtils.toObject(get(url), new TypeReference<Result<T>>() {});
    }

    public Result<Object> getResult(String url, Map<String, ?> param) {
        return getResult(url, param, Object.class);
    }

    public Result<Object> getResult(String url) {
    ...
    public <T, K> Result<T> postResult(String url, K body, HttpHeaders headers, Class<T> type) {
        return ConvertUtils.toObject(post(url, body, headers), new TypeReference<Result<T>>() {});
    }

    public <T, K> Result<T> postResult(String url, K body, Class<T> type) {
        return ConvertUtils.toObject(post(url, body), new TypeReference<Result<T>>() {});
    }

    public <K> Result<Object> postResult(String url, K body, HttpHeaders headers) {
        return postResult(url, body, headers, Object.class);
    }

    public <K> Result<Object> postResult(String url, K body) {
